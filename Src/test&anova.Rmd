...
table(data$Status)
```
I civili sono solo 2 quindi o li incorporo con qualcun altro
Space science e technology development sempre pochi==>potrei incorporare space science con earth observation e technology development con communications?




TEST: SIAMO NEL CASO DI PAIRED DATA ==> SIA NOI CHE LE AGENZIE SPAZIALI MISURIAMO LA STESSA QUANTITà: il tempo di vita atteso
...
p_val #0.000
```
Il continente è un fattore significativo ==>c'è evidenza statistica per permetterci diaffermare che  alcuni continenti mentono in media più di altri
...
sum(T_cp >= T0_cp)/B #0.004
```

The interaction between users and purpose is SIGNIFICANT
