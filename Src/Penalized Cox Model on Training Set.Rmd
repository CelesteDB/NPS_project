...
pred <- coxed(cox18, newdata=dummy_test_set1, method="npsf") #ERRORE: LUNGHEZZE DIFFERISCONO. ???????
pred <- coxed(cox18, newdata=dummy_test_set1, method="npsf", bootstrap=TRUE, B=1000)
pred$exp.dur
