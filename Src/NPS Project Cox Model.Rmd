...
#Insomma, apogeo, periodo, perigeo, inclinazione, eccentricità
...
Status <- data$Status
# , "Mass", "Longitude of GEO",
covariates <- c("Purpose.mod",  "Period", "")

cox1 <- coxph(Surv(time, Status == 'retired') ~ strata(Purpose.mod) + Periodcat, data = data[,covariates])
